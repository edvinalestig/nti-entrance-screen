...
class Reseplaneraren():
    ...
    def __renew_token(self):
        ...
        self.__token = "Bearer " + response_dict.get("access_token")
...
if __name__ == "__main__":
    ...
    vt = Reseplaneraren(key.strip(), secret.strip(), 0)
    ...
    print(vt.trip(originId=stop1, destId=stop2, date=20190210, time="15:24"))
    # print(vt.token)